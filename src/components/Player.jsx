    ...
    <div className='h-[10%] bg-black flex justify-between items-center text-white px-4'>
      ...
      <div className="flex flex-col items-center gap-1 m-auto">
        <div className="flex gap-4">
            ...
            <img src={assets.prev_icon} alt="previcon" className="w-4 cursor-pointer" onClick={previous}/>
            {
              isPlaying?
            ...
            <img src={assets.next_icon} alt="nexticon" className="w-4 cursor-pointer" onClick={next}/>
